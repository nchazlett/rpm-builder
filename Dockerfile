...
RUN curl -sSL https://github.com/ehazlett/cert-tool/releases/download/0.0.3/cert-tool_linux_amd64 > /usr/local/bin/cert-tool && chmod +x /usr/local/bin/cert-tool
